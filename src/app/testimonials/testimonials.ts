...
export const data: ITestimonial[] = [
  {
    author: {
      avatar: require('@/img/avatars/debbie-corbett.jpeg').default.src,
      name: 'John Doe',
      title: 'Softwaer Engineer',
      company: 'Apple',
      linkedInUrl: 'https://www.linkedin.com/',
    },
    date: '05/03/23, 10:52 AM',
    feedback:
...
export const colleagues: ITestimonial[] = [
  {
    author: {
      avatar: require('@/img/avatars/debbie-corbett.jpeg').default.src,
      name: 'Debbie Corbett',
...
export const mentees: ITestimonial[] = [
  {
    author: {
      avatar: require('@/img/avatars/sam-bradbury.jpeg').default.src,
      name: 'Sam Bradbury',
      title: 'Student with RMIT',
      company: 'Apple',
...
export const testimonials: ITestimonial[] = [
  {
    author: {
      ...
      company: 'ANZ',
      linkedInUrl: 'https://www.linkedin.com/in/ooanishoo',
    },
    feedback:
