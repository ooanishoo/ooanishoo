  ...
  return (
    <div>
      ...
      <p className=" mb-8 mt-6 text-sm text-gray-800 dark:text-slate-400  sm:text-lg">
        {`If you're a kindred spirit who appreciates the beauty of both technology and music, I'd love to connect. We can chat about anything from our favorite coding languages, your best workout routines or even share a few guitar chords.`}
      </p>
      <p className=" mb-8 mt-6 text-sm text-gray-800 dark:text-slate-400  sm:text-lg">
